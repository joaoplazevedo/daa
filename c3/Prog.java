// -------------------------------------------------------------
// Design and Analysis of Algorithms 2025/2026 (FCUP)
// File: Prog.java
//
...
class Graph {
  ...
  boolean dfs_hasCycle(int v) {
    ...
    for (int w : nodes[v].adj) {
      ...
      if (nodes[w].color == Color.WHITE)
        value = dfs_hasCycle(w);
    }
...
public class Prog {
  ...
  public static void main(String[] args) {
    ...
    // For each graph: read, call the method, output the result, and delete graph at
    // the end
